    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/95 backdrop-blur-xl animate-in fade-in duration-500 dark:bg-zinc-950/95">
            <div className="w-full max-w-lg p-8 text-center">
                ...
                <h1 className="mb-2 text-4xl font-extrabold text-zinc-900 animate-in slide-in-from-bottom-4 fade-in duration-1000 delay-300 dark:text-white">
                    YOU DID IT!
                </h1>
                ...
                <div className="mb-8 text-lg font-medium text-zinc-500 animate-in slide-in-from-bottom-4 fade-in duration-1000 delay-500 dark:text-zinc-400">
                    You completed the MOST IMPACTFUL action of your day.
                </div>
                ...
                <div className="mb-8 space-y-4 rounded-2xl bg-zinc-50 p-6 ring-1 ring-zinc-100 animate-in slide-in-from-bottom-8 fade-in duration-1000 delay-700 dark:bg-zinc-900 dark:ring-zinc-800">
                    ...
                    <div className="flex items-center justify-between border-b border-zinc-200 pb-3 dark:border-zinc-800">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-zinc-700 dark:text-zinc-200">Weekly Goal</span>
                        </div>
                        <div className="text-right">
                            <div className="font-bold text-zinc-900 dark:text-white">60% Done</div>
                            <div className="text-xs text-emerald-600 dark:text-emerald-400">+20% today</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between border-b border-zinc-200 pb-3 dark:border-zinc-800">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-zinc-700 dark:text-zinc-200">Day Streak</span>
                        </div>
                        <div className="text-right">
                            <div className="font-bold text-zinc-900 dark:text-white">{user.streak} Days</div>
                            <div className="text-xs text-orange-600 dark:text-orange-400">On fire! 🔥</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-zinc-700 dark:text-zinc-200">Impact</span>
                        </div>
                        <div className="text-right">
                            <div className="font-bold text-zinc-900 dark:text-white">High</div>
                            <div className="text-xs text-zinc-500">Investor Ready</div>
                        </div>
                    </div>
