    ...
    return (
        <div className="mx-auto w-full max-w-2xl animate-in slide-in-from-bottom-8 fade-in duration-500">
            <div className="mb-6 text-center">
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Capture today in one sentence</h2>
                <p className="text-zinc-500 dark:text-zinc-400">Optional. What did you learn? What surprised you?</p>
            </div>
