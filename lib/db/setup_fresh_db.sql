-- GLOWAPPLIFY MASTER SETUP SCRIPT
-- RUN THIS ON A FRESH PROJECT TO SET UP EVERYTHING

-- ==========================================
-- PART 1: CORE SCHEMA (Users, Boards, core features)
-- ==========================================
...
-- ==========================================
-- PART 2: LIFE AREAS SYSTEM (The New Connection Layer)
-- ==========================================
...
create table public.life_areas (
  id uuid primary key default gen_random_uuid(),
  user_id uuid references public.profiles(id) on delete cascade not null,
  area_type text not null, -- 'finances', 'health', 'learning', etc
...
-- 10. AREA CONNECTIONS (Interrelationships)
create table public.area_connections (
  ...
  description text,
  detected_by text default 'user',
  
  created_at timestamptz default now()
);

-- 11. LINK EXISTING TABLES TO LIFE AREAS
-- Update GOALS
...
-- ==========================================
-- PART 3: SECURITY & PERMISSIONS (RLS)
-- ==========================================
